...
(function() {
  ...
  module.run([
    '$templateCache', function($templateCache) {
      return $templateCache.put('contrib/hall', '<div contrib-hall-webhooks="contrib-hall-webhooks" ng-controller="ContribHallAdminController as ctrl"><header><h1 tg-main-title="tg-main-title"></h1></header><form><label for="url">Hall webhook url</label><div class="contrib-form-wrapper"><fieldset><input type="text" name="url" ng-model="hallhook.url" placeholder="Hall webhook url" id="url" data-type="url"/></fieldset><fieldset ng-show="hallhook.id" class="contrib-test"><a href="" title="Test" ng-click="ctrl.testHook()" class="button-gray"><span>Test</span></a></fieldset></div><button type="submit" class="hidden"></button><a href="" title="Save" ng-click="ctrl.updateOrCreateHook(hallhook)" class="button-green submit-button"><span>Save</span></a></form><a href="https://taiga.io/support/hall-integration/" target="_blank" class="help-button"><span class="icon icon-help"></span><span>Do you need help? Check out our support page!</span></a></div>');
    }
  ]);
